...
//  Ren-Swiftui
//
//  Created by betterchris on 2023/1/10.
//
...
struct SheetPresentationForSwiftUI<Content>: UIViewRepresentable where Content: View {
    ...
    func updateUIView(_ uiView: UIView, context: Context) {
        ...
        // viewController.view.backgroundColor = UIColor.red //.withAlphaComponent(0.3)
        ...
        if let sheetController = viewController.presentationController as? UISheetPresentationController {
            ...
            sheetController.largestUndimmedDetentIdentifier = .large//.medium
            //sheetController.presentedView?.backgroundColor =
        }
